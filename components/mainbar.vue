<template>
    <div class="basis-10/12 bg-slate-50 ">
        ...
        <div class="font-bold">Welcome <br/><span class="font-light">Lekside081</span></div>
        </div>

        <div class="flex flex-row">
            <div class="basis-72 bg-blue-900 rounded-lg py-3 ml-4 mt-4">
            <div class="px-4 text-white">Staking Interest(Ledger)</div>
            <div class="flex justify-between px-4 text-white">
            <div class="text-2xl font">600.6 USDT</div>
            <div><svg class="w-6 h-6 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                <path fill-rule="evenodd" d="M4.998 7.78C6.729 6.345 9.198 5 12 5c2.802 0 5.27 1.345 7.002 2.78a12.713 12.713 0 0 1 2.096 2.183c.253.344.465.682.618.997.14.286.284.658.284 1.04s-.145.754-.284 1.04a6.6 6.6 0 0 1-.618.997 12.712 12.712 0 0 1-2.096 2.183C17.271 17.655 14.802 19 12 19c-2.802 0-5.27-1.345-7.002-2.78a12.712 12.712 0 0 1-2.096-2.183 6.6 6.6 0 0 1-.618-.997C2.144 12.754 2 12.382 2 12s.145-.754.284-1.04c.153-.315.365-.653.618-.997A12.714 12.714 0 0 1 4.998 7.78ZM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" clip-rule="evenodd"/>
              </svg>
              </div>
              </div>
              <div class="px-6 underline text-white text-xs">Refresh</div>
              </div> 
        </div>
        ...
        <div class="flex flex-row mt-4 justify-between space-x-5 px-4">
            <div class="basis-1/3 bg-zinc-100">
                <div class="flex flex-row justify-between mt-3 px-4">
                    <div>SZCB Main</div>
                    <div class="mt-3"><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div class="font-bold px-4">SZCB</div>
                <div class="px-4">0</div>
            </div>
            ...
            <div class="basis-1/3 bg-zinc-100">
                ...
                <div class="font-bold px-4">USDT</div>
                <div class="px-4">0</div>
            </div>
            ...
            <div class="basis-1/3 bg-zinc-100">
                ...
                <div class="font-bold px-4">BNB</div>
                <div class="px-4">0</div>
            </div>
        </div>
            ...
            <div class="flex flex-row space-x-4 px-4">
                <div class="basis-1/3 bg-blue-900 rounded-lg py-3">
                    ...
                    <div class="flex justify-center">
                        <a href="/deposite" class="flex space-x-4">
                        <div><svg class="w-[22px] h-[22px] text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <div class="basis-1/3 bg-blue-900 rounded-lg py-3">
                    ...
                    <div class="flex justify-center">
                        <a href="/withdrawal" class="flex space-x-4">
                        <div><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5 text-white">
                            <path d="M9.25 13.25a.75.75 0 0 0 1.5 0V4.636l2.955 3.129a.75.75 0 0 0 1.09-1.03l-4.25-4.5a.75.75 0 0 0-1.09 0l-4.25 4.5a.75.75 0 1 0 1.09 1.03L9.25 4.636v8.614Z" />
                            <path d="M3.5 12.75a.75.75 0 0 0-1.5 0v2.5A2.75 2.75 0 0 0 4.75 18h10.5A2.75 2.75 0 0 0 18 15.25v-2.5a.75.75 0 0 0-1.5 0v2.5c0 .69-.56 1.25-1.25 1.25H4.75c-.69 0-1.25-.56-1.25-1.25v-2.5Z" />
                          </svg>
                          
                          </div>
                          <div class="text-white">Withdrawal</div>
                        </a>
                    </div>
                </div>
                <div class="basis-1/3 bg-blue-900 rounded-lg py-3">
                    ...
                    <div class="flex justify-center">
                        <a href="/swap" class="flex space-x-4">
                        <div><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5 text-white">
